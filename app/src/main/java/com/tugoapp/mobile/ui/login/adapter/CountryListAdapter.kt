package com.tugoapp.mobile.ui.login.adapter
...
class CountryListAdapter(val context: Context, var dataSource: List<CountryCodeModel>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.text = dataSource[position].flag
        return view
    }
    ...
    private class ItemHolder(row: View?) {
        var label: TextView = row?.findViewById(R.id.countryName) as TextView
