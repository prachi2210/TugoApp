...
interface MerchantApiService { //
    ...
    @POST("getProviderDetailsAdvacev2")
    fun doGetProviderDetailsAdvance(@Header("token") token: String?, @Body data : GetProviderDetailRequestModel): Call<GetProviderDetailsResponseModel>

    @POST("placeOrder")
    fun doPlaceOrder(@Header("token") token: String?, @Body data : PlaceOrderRequestModel?): Call<PlaceOrderResponseModel>

    @POST("placeOrderv2")
    fun doPlaceOrderV2(@Header("token") token: String?, @Body data : PlaceOrderRequestModel?): Call<PlaceOrderResponseModel>
