...
@Parcelize
public data class MealOptionsModel(var planId : String?, var weeks : String?, var noOfDays : String? ,var noOfMeals : String?,var price : String?,var amount : String?,var priceWithSnack : String?,var amountWithSnack : String?,
                                   var mealId : String?,var maxSnack: String?,var pricePerSnack : String?,var originalPrice : String?,var sortOrder : String?,var discount : String?, var snackQty : String = "0") : Parcelable{}
